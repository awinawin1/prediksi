            ...
            <div class="row">
                <div class="card">
                    <div class="card-body pb-5">
                        ...
                        <br>
                        <h4><b>Sumber Data</b></h4>
                        <p>Dataset CHB-MIT1, terdiri dari catatan dari 23 pasien; dengan satu kasus (chb21) diambil dari pasien yang sama (chb01) 1,5 tahun kemudian. Kumpulan data dikumpulkan oleh penyelidik di Rumah Sakit Anak Boston dan Massachusetts Institute of Technology (MIT). Panjang rata-rata pengumpulan adalah selama 36 jam dengan celah kecil antara catatan setiap jam karena keterbatasan perangkat keras.</p>
                        <br><h4 class="border-top"><b>Data {{$namaFile}}</b></h4>
                        <p>Sinyal {{$namaFile}} merupakan pasien yang memiliki usia {{$age}} tahun dan berjenis kelamin {{$gender}}. Pada proses pencatatan sinyal pasien terdapat {{$seizure}} kejang. Kejang terjadi selama {{$ictal}} detik dan sebelum kejang atau interiktal terjadi selama {{$inter}} detik.</p>
                    </div>
                </div>
            </div>
            <div class="row">
